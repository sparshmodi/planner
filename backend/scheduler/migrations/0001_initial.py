# Generated by Django 5.0.8 on 2024-10-27 14:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_schedules', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None), null=True, size=None)),
            ],
        ),
        migrations.CreateModel(
            name='ClassSchedule',
            fields=[
                ...
                ('associated_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule_data', to='scheduler.class')),
            ],
        ),
        migrations.AddField(
            model_name='class',
            name='associated_course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='scheduler.course'),
        ),
        migrations.CreateModel(
            name='CoursesOverlap',
            fields=[
